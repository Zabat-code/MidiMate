const fs = require('fs');
const path = '/c/Users/Winuser/Downloads/piano-app-upload/src/i18.js';
...
newSrc = newSrc.replace('  // update etiquetas que dependen de i18n', '  // Update labels that depend on i18n');
